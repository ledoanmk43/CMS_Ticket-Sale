    ...
    <div className='sidebar'>
      ...
      <div className='sidebar-container'>
        ...
        <div className='sidebar-container-item'>
          ...
          <a className='sidebar-container-item-link' href='/TicketCheck'>
            Đối soát vé
          </a>
        </div>
        <div
        ...
        >
          ...
          <a className='sidebar-container-item-link' href='/ServicePacks'>
            Cài đặt
          </a>
        </div>
        <div
          className={'sidebar-container-sub' + (isSettingOpen ? '' : '-hidden')}
        >
          Gói dịch vụ
        </div>
      </div>
