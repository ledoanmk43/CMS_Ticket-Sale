...
const MenuAntd: React.FunctionComponent<IMenuAntdProps> = (
  ...
  const [isCarlendarUpdateOpen, setIsCarlendarUpdateOpen] =
      ...
      {modalChangeDate && (
        ...
        >
          ...
          <div className='flex row change-date'>
            ...
            <DatePicker
              onClick={() => setIsCarlendarUpdateOpen(!isCarlendarUpdateOpen)}
              ...
              allowClear={false}
            />
            {isCarlendarUpdateOpen && (
              <Calendar
                setIsCarlendarOpen={setIsCarlendarUpdateOpen}
                setDate={setDateUpdate}
                onClickOutside={() => {
                  setIsCarlendarUpdateOpen(false)
                }}
              />
            )}
          </div>
