...
const ServicePack: React.FunctionComponent<IServicePackProps> = (
  ...
  //Add
  const [packageNameAdd, setPackageNameAdd] = useState<any>(null)
  const [packageStatusAdd, setPackageStatusAdd] = useState<any>(null)
  const [ticketPriceAdd, setTicketPriceAdd] = useState<any>(null)
  const [comboPriceAdd, setComboPriceAdd] = useState<any>(null)
  //Edit
  const [packageNameEdit, setPackageNameEdit] = useState<any>(null)
  const [packageStatusEdit, setPackageStatusEdit] = useState<any>(null)
  const [ticketPriceEdit, setTicketPriceEdit] = useState<any>(null)
  const [comboPriceEdit, setComboPriceEdit] = useState<any>(null)
          ...
          >
            ...
            <div className='package-input mt-3rem'>
              ...
              <div className='select-status'>
                <Select
                  onChange={(value) => setPackageStatusEdit(value)}
                  style={{
                    maxWidth: '160px',
