...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  //     if (isCalendarOpen && ref.current && !ref.current.contains(e.target)) {
          ...
          >
            <div className='date-picker'>
              <div className='from'>
                ...
                <DatePicker
                  onClick={() => setIsCalendarFromOpen((oldState) => !oldState)}
                  ...
                  allowClear={false}
                />
                {isCalendaFromOpen && <Calendar />}
              </div>
              <div className='to'>
                <p className='heading-base'>Đến ngày</p>
                <DatePicker
                  onClick={() => setIsCalendarOpen((oldState) => !oldState)}
                  style={{ position: 'relative' }}
                  defaultValue={moment(new Date(), 'DD MMM, YYYY')}
                  defaultPickerValue={moment(new Date(), 'DD MMM, YYYY')}
                  format={'DD MMM, YYYY'}
