...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  const typingTimeoutRef = useRef<null | any>(null)

  const [searchValue, setSearchValue] = useState<string | null>(null)

  const debounceSearch = useDebounce(searchValue, 3000)
  ...
  return (
    <div className='main h-base col'>
      <div className='container'>
        ...
        <TableAntd ticketsData={props.ticketsData} searchValue={searchValue} />
        {isOpenModal && (
          <Modal
            visible={isOpenModal}
            centered
