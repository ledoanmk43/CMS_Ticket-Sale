...
const ServicePack: React.FunctionComponent<IServicePackProps> = (
  ...
  const handleAddPack = async () => {
    ...
    var nexDate = date.setFullYear(date.getFullYear() + 1)
    const docData = {
      id:
      ...
      dateBegin: Timestamp.fromDate(date),
      dateEnd: Timestamp.fromDate(    var nexDate = date.setFullYear(date.getFullYear() + 1)
),
