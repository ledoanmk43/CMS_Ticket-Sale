...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  useEffect(() => {
    ...
    setDataUpdate(props.ticketsData)
    setDateUpdate(
      props.ticketsData.map((item: any) => ({
        ...item,
        dateUse: dateUpdate.dateUse,
      }))
    )
  }, [debounceSearch, props.ticketsData, filterValue])
  console.log('dateUpdate.dateUse first', dateUpdate.dateUse)
  console.log(' dataUpdate.dateUse ', dateUpdate)
  return (
              ...
              <DatePicker
                ...
                value={
                  dataUpdate.dateUse === new Date()
                    ? moment(dataUpdate.dateUse, 'DD/MM/YYYY')
                    : moment(dateUpdate, 'DD/MM/YYYY')
                }
                defaultValue={moment(
                  new Date(dataUpdate.dateUse),
                  'DD/MM/YYYY'
                )}
                format={'DD/MM/YYYY'}
                allowClear={false}
