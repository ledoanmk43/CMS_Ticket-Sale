...
const changeStatus = async () => {
  const update: any = document.getElementsByClassName('#doan')
  try {
    const ticketRef = doc(db, 'tickets', update)
...
const menu = (
  <Menu className='menu' onClick={changeStatus}>
    <Menu.Item key=''>Sử dụng vé</Menu.Item>
    <Menu.Item>Đổi ngày sử dụng</Menu.Item>
  </Menu>
)
const columns = [
  {
  ...
  },
  {
    ...
    render: (status: string) => {
      ...
      return (
        ...
        >
          <GoPrimitiveDot id='doan' className='icon' /> {statusName}
        </div>
      )
    },
  },
