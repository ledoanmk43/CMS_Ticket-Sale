...
const TicketCheck: React.FunctionComponent<ITicketCheckProps> = (
  ...
  console.log('Hello ', typeof checkedStatus)
  useEffect(() => {
    if (debounceSearch) {
      setTableData(
        ...
        setDefaultData(
          props.ticketsData.filter((item: Ticket) => {
            for (let i = 0; i < filterValue.length; i++) {
              if (
                String(item.checkingStatus) === filterValue[i].checkingStatus &&
          ...
          <div className='section-col'>
            ...
            <div className='section flex-start'>
              ...
              <div className='ml-2rem'>
                ...
                {isCalendaFromOpen && (
                  <Calendar
                    setIsCarlendarOpen={setIsCalendarFromOpen}
                    setDate={setDateFrom}
                    onClickOutside={() => {
            ...
            <div className='section flex-start'>
              ...
              <div className='ml-2rem'>
                ...
                {isCalendarToOpen && (
                  <Calendar
                    setIsCarlendarOpen={setIsCalendarToOpen}
                    setDate={setDateTo}
                    onClickOutside={() => {
