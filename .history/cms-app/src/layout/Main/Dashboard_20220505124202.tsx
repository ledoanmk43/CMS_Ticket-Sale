...
const Dashboard: React.FunctionComponent<IDashboardProps> = (
  ...
  //area chart
  const [dataArea, setDataArea] = useState<any>([props.ticketsData])
  const options = { month: 'short', day: 'numeric' }
  const hanleDashboard = () => {
    setDataArea(
      props.ticketsDataChart.map((item: any) => {
        return {
  ...
  }, [props.ticketsData, props.ticketsDataChart])
  console.log('dataArea nè', dataArea)
