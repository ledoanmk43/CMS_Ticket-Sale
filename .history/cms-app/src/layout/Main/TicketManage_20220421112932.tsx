...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  const options = [
    { label: 'Tất cả', value: 'Apple' },
    { label: 'Đã sử dụng', value: 'Pear' },
    { label: 'Chưa sử dụng', value: 'Orange' },
    { label: 'Hết hạn', value: 'Orange' },
  ]
    ...
    <div className='main h-base col'>
      <div className='container'>
        ...
        <TableAntd
          ...
          checkedListGate={checkedListGate}
        />
        {isOpenModal && (
          <Modal
            visible={isOpenModal}
          ...
          >
            ...
            <div className='status'>
              ...
              <Radio.Group options={options} onChange={onChangeGate} value={'Tất cả'} />
            </div>
            <div className='gate'>
