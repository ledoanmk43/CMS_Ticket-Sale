...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  const [dataUpdate, setdataUpdate] = useState(second)
        ...
        {modalChangeDate && (
          ...
          >
            <div className='flex row change-date'>
              ...
              <p className='heading-base'>{record.ticketId}</p>
            </div>
            <div className='flex row change-date'>
              <p className='heading-base'>Tên sự kiện</p>
              <p className='heading-base'>{record.eventName}</p>
            </div>
            <div className='flex row change-date'>
