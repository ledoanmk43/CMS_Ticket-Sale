...
const TicketManage: React.FunctionComponent<ITicketManageProps> = (
  ...
  console.log(' dataUpdate.dateUse first', dateUpdate)
  console.log('dateUpdate.dateUse ', dateUpdate.dateUse)
  return (
          ...
          >
            ...
            <div className='flex row change-date'>
              ...
              <DatePicker
                ...
                defaultPickerValue={moment(new Date(dateUpdate), 'DD/MM/YYYY')}
                format={'DD/MM/YYYY'}
                allowClear={false}
              />
              {isCalendarOpen && (
